...
pub fn WhatWeDo() -> Element {
    rsx! {
        h1 { class: "text-4xl", "What we do & How it works" }
        p {
        ...
        div { class: "flex md:flex-row",
                div {
                        ...
                        ul { class: "",
                                ...
                                li { "They are less clunky than other simlar products (no scanning) -> increases volume" }
                                li { "Easy to maintain " }
                                li {
                ...
                div {
                        ...
                        ul { class: "",
                                ...
                                li { "It encourages youth led sustainability programs (volunteering and leadership)." }
                                li {
